...
public interface IconRenderer {
	...
	static IconRenderer of(IconHolder icon) {
		if (icon.renderer instanceof IconRenderer renderer) {
			return renderer;
		}

		icon.renderer = create(icon.icon);
		return (IconRenderer) icon.renderer;
	}
