...
public interface InternalServerData {
	...
	DataKey<Boolean> IMMUTABLE_WORLD = DataKey.SERVER.createDefault("immutable_world", RegisteredDataType.BOOL, false);
	...
	DataKey<Boolean> HIDE_PLUMBOBS = DataKey.SERVER.createDefault("hide_plumbobs", RegisteredDataType.BOOL, false);
