...
public class BrightCubeProp extends Prop {
	public static final PropData<BrightCubeProp, Color> COLOR = PropData.create(BrightCubeProp.class, "color", Color.DATA_TYPE, p -> p.color, (p, v) -> p.color = v);
	public static final PropData<BrightCubeProp, Color> OUTLINE_COLOR = PropData.create(BrightCubeProp.class, "outline_color", Color.DATA_TYPE, p -> p.outlineColor, (p, v) -> p.outlineColor = v);
