		...
		.then(Commands.literal("set")
			.then(Commands.argument("player", EntityArgument.players())
				.then(Commands.literal("custom")
					.then(Commands.argument("clothing", ClothingSet.DATA_TYPE.argument(buildContext))
						.executes(ctx -> setClothing(EntityArgument.getPlayers(ctx, "player"), PlayerClothing.custom(ClothingSet.DATA_TYPE.get(ctx, "clothing"))))
					)
				)
