...
public record CustomCutsceneEventHolder(String name) implements CutsceneEvent {
	public static final SimpleRegistryType<CustomCutsceneEventHolder> TYPE = SimpleRegistryType.dynamic("custom", RecordCodecBuilder.mapCodec(instance -> instance.group(
