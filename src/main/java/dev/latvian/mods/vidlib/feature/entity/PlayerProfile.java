...
public record PlayerProfile(GameProfile profile, long lastUpdate, Optional<String> skinUrl, boolean slimModel) {
	...
	public static final PlayerProfile STEVE = new PlayerProfile(new GameProfile(UUID.fromString("00000000-0000-0000-0000-000000000001"), "Steve"), 0L, Optional.empty(), false);
