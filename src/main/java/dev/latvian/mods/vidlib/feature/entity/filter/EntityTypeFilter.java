...
public record EntityTypeFilter(EntityType<?> entityType) implements EntityFilter, ImBuilderWithHolder.Factory {
	public static DynamicType<RegistryFriendlyByteBuf, EntityFilter> TYPE = CustomRegistryType.dynamic("entity_type", RecordCodecBuilder.mapCodec(instance -> instance.group(
