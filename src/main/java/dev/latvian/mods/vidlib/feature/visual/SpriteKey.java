...
public final class SpriteKey {
	...
	public static final ResourceLocation BLOCKS = ResourceLocation.tryBuild("minecraft", "textures/atlas/blocks.png");
	public static final ResourceLocation PARTICLES = ResourceLocation.tryBuild("minecraft", "textures/atlas/particles.png");
	public static final ResourceLocation GUI = ResourceLocation.tryBuild("minecraft", "textures/atlas/gui.png");

	public static final ResourceLocation MISSING_SPRITE = ResourceLocation.tryBuild("minecraft", "missingno");
