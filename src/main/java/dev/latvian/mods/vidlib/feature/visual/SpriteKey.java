...
public final class SpriteKey {
	...
	public static final ClientAsset BLOCKS = new ClientAsset(ResourceLocation.tryBuild("minecraft", "atlas/blocks.png"));
	public static final ClientAsset PARTICLES = new ClientAsset(ResourceLocation.tryBuild("minecraft", "atlas/particles.png"));
	public static final ClientAsset GUI = new ClientAsset(ResourceLocation.tryBuild("minecraft", "atlas/gui.png"));

	public static final ClientAsset MISSING_SPRITE = new ClientAsset(ResourceLocation.tryBuild("minecraft", "missingno"));
