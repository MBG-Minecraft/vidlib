...
public record ServerDataEntityFilter(String key, Supplier<DataKey<?>> dataKey) implements EntityFilter, ImBuilderWrapper.BuilderSupplier {
	...
	public static class Builder implements EntityFilterImBuilder {
		public static final ImBuilderHolder<EntityFilter> TYPE = new ImBuilderHolder<>("Server Data", Builder::new);
