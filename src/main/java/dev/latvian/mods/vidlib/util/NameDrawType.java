...
public enum NameDrawType implements StringRepresentable {
	...
	public static final NameDrawType[] VALUES = values();
	public static final DataType<NameDrawType> DATA_TYPE = DataType.of(VALUES);

	private final String name;
	public final Tristate renderName;
	public final Tristate renderHealth;

	NameDrawType(String name, Tristate renderName, Tristate renderHealth) {
		this.name = name;
