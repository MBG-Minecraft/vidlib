...
public class SelectedPropReplaySessionData implements ReplaySessionData {
	public static final ReplaySessionDataType<SelectedPropReplaySessionData> TYPE = new ReplaySessionDataType<>(ID.vidlib("selected_prop"), SelectedPropReplaySessionData::new);
