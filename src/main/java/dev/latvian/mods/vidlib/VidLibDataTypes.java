...
public class VidLibDataTypes {
	public static void register() {
		...
		DataType.register(VidLib.id("cutscene"), Cutscene.DATA_TYPE, Cutscene.REGISTRY);
		...
		DataType.register(VidLib.id("zone_container"), ZoneContainer.DATA_TYPE, ZoneContainer.REGISTRY);
		DataType.register(VidLib.id("location"), Location.DATA_TYPE, Location.REGISTRY);
