...
import dev.beast.mods.shimmer.feature.particle.CustomParticle;
...
public class NPCParticle extends CustomParticle {
	...
	public void renderCustom(PoseStack ms, MultiBufferSource buffers, Camera camera, float delta) {
		...
		playerRenderState.setRenderData(MiscShimmerClientUtils.CLOTHING, recording.get(NPCDataType.CLOTHING, offset));
