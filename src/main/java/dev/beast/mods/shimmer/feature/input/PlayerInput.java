...
public record PlayerInput(
	int flags,
	// Movement
	boolean forward, boolean back, boolean left, boolean right, boolean jumping, boolean sneaking,
	// Modifiers
	...
	public PlayerInput(int flags) {
		this(
			flags,
			// Movement
			(flags & (1 << 0)) != 0, (flags & (1 << 1)) != 0, (flags & (1 << 2)) != 0, (flags & (1 << 3)) != 0, (flags & (1 << 4)) != 0, (flags & (1 << 5)) != 0,
			// Keys
			(flags & (1 << 6)) != 0, (flags & (1 << 7)) != 0, (flags & (1 << 8)) != 0, (flags & (1 << 9)) != 0,
			// Mouse
			(flags & (1 << 10)) != 0, (flags & (1 << 11)) != 0, (flags & (1 << 12)) != 0, (flags & (1 << 13)) != 0, (flags & (1 << 14)) != 0
		);
	}
	...
	public static int getFlags(
		...
		if (shift) flags |= 1 << 6;
		if (control) flags |= 1 << 7;
		if (alt) flags |= 1 << 8;
		if (tab) flags |= 1 << 9;
		if (mouseLeft) flags |= 1 << 10;
		if (mouseRight) flags |= 1 << 11;
		if (mouseMiddle) flags |= 1 << 12;
		if (mouseBack) flags |= 1 << 13;
		if (mouseNext) flags |= 1 << 14;
		//@formatter:on
