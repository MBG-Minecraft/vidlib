...
public class ZoneEvent extends Event {
	public static class EntityEvent extends ZoneEvent {
		...
		public EntityEvent(ZoneInstance zoneInstance, Entity entity) {
	...
	public static class EntityEntered extends EntityEvent {
		public EntityEntered(ZoneInstance zoneInstance, Entity entity) {
			super(zoneInstance, entity);
		}
	}

	public static class EntityExited extends EntityEvent {
		public EntityExited(ZoneInstance zoneInstance, Entity entity) {
			super(zoneInstance, entity);
		}
	}
