...
public class PhysicsParticleData {
	...
	public static final KnownCodec<PhysicsParticleData> KNOWN_CODEC = KnownCodec.register(Shimmer.id("physics_particle_data"), CODEC, STREAM_CODEC, PhysicsParticleData.class);
	...
	public static class Loader extends JsonCodecReloadListener<PhysicsParticleData> {
		public Loader() {
			super("shimmer/physics_particle_data", CODEC, false);
		}
